...
use crate::formula::clmm::u256_math::mul_u256;
...
mod fuzz_tests {
    ...
    use super::*;
    use crate::formula::clmm::u256_math::U256;
...
mod test_tick_index_from_sqrt_price {
    use crate::formula::clmm::orca_swap_state::{MAX_TICK_INDEX, MIN_TICK_INDEX};
    use super::*;
    ...
    fn test_sqrt_price_to_tick() {
        let sqrt_price_x64: Vec<u128> = vec![
            ...
            MAX_SQRT_PRICE_X64,
            MIN_SQRT_PRICE_X64,
            40038806028197242435,
            40040807918452647031,
            40042809908800062159,
            40044811999244492295,
            40046814189790942165,
            40048816480444416744,
            40050818871209921259,
            40052821362092461186,
            40054823953097042251,
            40056826644228670432,
            40058829435492351956,
            40060832326893093299,
            40062835318435901191,
            40064838410125782609,
            40066841601967744781,
            40068844893966795187,
            40070848286127941555,
            40072851778456191866,
            40074855370956554350,
            40076859063634037486,
            40078862856493650005,
            40080866749540400889,
            40082870742779299370,
            40084874836215354929,
            40086879029853577300,
            40088883323698976465,
            40090887717756562658,
            40092892212031346363,
            40094896806528338314,
            40096901501252549497,
            40098906296208991148,
            40100911191402674752,
            40102916186838612047,
            40104921282521815020,
            40106926478457295908,
            40108931774650067201,
            40110937171105141638,
            40112942667827532208,
            40114948264822252152,
            40116953962094314961,
            40118959759648734377,
            40120965657490524393,
            40122971655624699251,
            40124977754056273445,
            40126983952790261720,
            40128990251831679072,
            40130996651185540747,
            40133003150856862240,
            40135009750850659301,
            40137016451171947926,
        ];

        sqrt_price_x64.iter().for_each(|x| {
            println!("{}", tick_index_from_sqrt_price(&x))
        })
    }
    ...
    fn test_tick_to_sqrt_price() {
        ...
        tick.iter().for_each(|x| {
            println!("{}", sqrt_price_from_tick_index(*x))
        })
    }
